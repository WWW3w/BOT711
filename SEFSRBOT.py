...
TOKEN = '7311666650:AAEvIokqA34XCIJdlhsitBb5oDoUWZyZuGw' #توكنك بوت بدل كلمه token
ADMIN_ID = 6207801307  # ايديك حسابك التلي بدل كلمه ID
channel = '@VELTRlX' #يوزر قناتك هنا مش الرابط 

# ممنوع تغيير المصدر @R3B4x
...
def ask_for_subscription(chat_id):
    ...
    join_button = types.InlineKeyboardButton('📢 اشترك في القناة', url=f'https://t.me/VELTRlX')
    markup.add(join_button)
    bot.send_message(chat_id, f"📢 عزيزي المستخدم، عليك الاشتراك في القناة {VELTRlX} لتتمكن من استخدام البوت.", reply_markup=markup)
...
def send_welcome(message):
    ...
    dev_channel_button = types.InlineKeyboardButton('🔧 قناة المطور', url='https://t.me/VELTRlX')
...
def delete_uploaded_file(chat_id):
    ...
    if folder_path and os.path.exists(folder_path):
        ...
        bot.send_message(chat_id, f"🗑️ تم حذف الملفات المتعلفةبالبوت")
    else:
        bot.send_message(chat_id, "⚠️ الملفات غير موجودة.")
# لا تغير الحقوق يا فاشل @R3B4x
# تنشر اذكر المصدر
#ممنوع تغيير الحقوق
#غير مسوول عن اي تعديل داخل الادات teaegram@R3B4x
